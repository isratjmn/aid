			...
			<div className="flex justify-center space-x-4 mt-4 mb-10">
				<button
					className={`category-button ${
						selectedCategory === "All Items" && "active"
					}`}
					onClick={() => filterItemsByCategory("All Items")}
				>
					All Items
				</button>
				<button
					className={`category-button ${
						selectedCategory === "Books" && "active"
					}`}
				...
				<button
					...
					onClick={() => filterItemsByCategory("Tshirt")}
				>
					Tshirt
				</button>
				<button
					className={`category-button ${
						selectedCategory === "Hat" && "active"
					}`}
					onClick={() => filterItemsByCategory("Hat")}
				>
					Hat
				</button>
			</div>
								...
								<div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
									<a href="#">
										<Image
											width={500}
											height={500}
											class="rounded-t-lg w-[500px] h-[400px]"
											src={item.picture}
											alt="no image"
										/>
									</a>
									<div class="p-5">
										<h2 class="mb-2 text-3xl font-bold  text-blue-500 dark:text-white">
											{item.name}
										</h2>
										...
										<Link
											href={`store-items/${item._id}`}
											class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-green-300 rounded-lg hover:bg-green-400 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-400 dark:hover:bg-green-500 dark:focus:ring-green-800"
										>
											Details{" "}
